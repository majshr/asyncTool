...
public class WorkerWrapper<T, V> {
    ...
    /**
     * 在自己后面的wrapper，如果没有，自己就是末尾；如果有一个，就是串行；如果有多个，有几个就需要开几个线程并行</p>
     * -------2
     * 1
     * -------3
     * 如1后面有2、3
    ...
    private boolean checkNextWrapperResult() {
        ...
        // 如果后面并行一个, 判断是否开始执行了, 如果没有, 继续向下判断
    ...
    /**
     * 结果为默认值返回true: 未执行; 结果不为默认值返回false: 执行完成了
     * 
     * @return boolean
     * @date: 2020年3月4日 下午5:48:00
     */
    ...
    public static class Builder<W, C> {
        ...
        /**
         * 添加当前任务执行完, 下一个执行的worker
         * 
         * @param wrapper
         * @param selfIsMust
         * @return Builder<W,C>
         * @date: 2020年3月4日 下午3:19:42
         */
        ...
        /**
         * 添加当前任务执行完, 下一个执行的worker(多个)
         * 
         * @param wrappers
         * @return Builder<W,C>
         * @date: 2020年3月4日 下午3:30:20
         */
